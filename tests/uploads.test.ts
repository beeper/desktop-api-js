import fs from 'fs';
import type { ResponseLike } from '@beeper/desktop-api-js/internal/to-file';
import { toFile } from '@beeper/desktop-api-js/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('@beeper/desktop-api-js/core/uploads');
    await expect(
