...
[![NPM version](<https://img.shields.io/npm/v/@beeper/desktop-api-js.svg?label=npm%20(stable)>)](https://npmjs.org/package/@beeper/desktop-api-js) ![npm bundle size](https://img.shields.io/bundlephobia/minzip/@beeper/desktop-api-js)
...
```sh
npm install @beeper/desktop-api-js
```
...
```ts
import BeeperDesktop from 'npm:@beeper/desktop-api-js';
