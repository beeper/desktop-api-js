...
[![NPM version](<https://img.shields.io/npm/v/desktop-api-js.svg?label=npm%20(stable)>)](https://npmjs.org/package/desktop-api-js) ![npm bundle size](https://img.shields.io/bundlephobia/minzip/desktop-api-js)
...
```ts
import BeeperDesktop from 'npm:desktop-api-js';
