...
export const sdkMethods: SdkMethod[] = [
  ...
  {
    clientCallName: 'client.bridges.connections.retrieve',
    fullyQualifiedName: 'bridges.connections.retrieve',
    httpMethod: 'get',
    httpPath: '/v1/bridges/{bridgeID}/connections/{loginID}',
  },
  {
    clientCallName: 'client.bridges.connections.list',
    fullyQualifiedName: 'bridges.connections.list',
    httpMethod: 'get',
    httpPath: '/v1/bridges/{bridgeID}/connections',
  },
  {
    clientCallName: 'client.bridges.connections.remove',
    fullyQualifiedName: 'bridges.connections.remove',
    httpMethod: 'post',
    httpPath: '/v1/bridges/{bridgeID}/connections/{loginID}/remove',
  },
  {
  ...
  },
  {
    ...
    httpMethod: 'post',
    httpPath: '/v1/app/login/verification/recovery-key',
  },
  {
    ...
    httpMethod: 'post',
    httpPath: '/v1/app/login/verification/recovery-key/reset',
  },
  {
