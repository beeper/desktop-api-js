...
const EMBEDDED_METHODS: MethodEntry[] = [
  ...
  },
  {
    ...
    "response": "{ results: { chats: object[]; in_groups: object[]; messages: { chats: object; hasMore: boolean; items: message[]; newestCursor: string; oldestCursor: string; }; }; }",
  ...
  },
  {
    ...
    "description": "Lists chat accounts across networks (WhatsApp, Telegram, Twitter/X, etc.) actively connected to this Beeper Desktop instance",
    "stainlessPath": "(resource) accounts > (method) list",
    "qualified": "client.accounts.list",
    "response": "{ accountID: string; bridge: { id: string; provider: 'cloud' | 'self-hosted' | 'local' | 'platform-sdk'; type: string; }; network: string; user: object; }[]",
  ...
  },
  {
    ...
    "description": "Search contacts on a specific account using merged account contacts, network search, and exact identifier lookup.",
    ...
    "response": "{ items: { id: string; cannotMessage?: boolean; email?: string; fullName?: string; imgURL?: string; isSelf?: boolean; phoneNumber?: string; username?: string; }[]; }",
  ...
  },
  {
    ...
    "response": "{ id: string; cannotMessage?: boolean; email?: string; fullName?: string; imgURL?: string; isSelf?: boolean; phoneNumber?: string; username?: string; }",
  ...
  },
  {
    ...
    "response": "{ id: string; accountID: string; participants: { hasMore: boolean; items: object[]; total: number; }; title: string; type: 'single' | 'group'; unreadCount: number; isArchived?: boolean; isMuted?: boolean; isPinned?: boolean; lastActivity?: string; lastReadMessageSortKey?: string; localChatID?: string; }",
  ...
  },
  {
    ...
    "description": "Create a single/group chat (mode='create') or start a direct chat from merged user data (mode='start').",
  ...
  },
  {
    ...
    "response": "{ id: string; accountID: string; participants: { hasMore: boolean; items: user[]; total: number; }; title: string; type: 'single' | 'group'; unreadCount: number; isArchived?: boolean; isMuted?: boolean; isPinned?: boolean; lastActivity?: string; lastReadMessageSortKey?: string; localChatID?: string; }",
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        ...
        "example": "beeper-desktop-cli chats:reminders create \\\n  --access-token 'My Access Token' \\\n  --chat-id '!NCdzlIaMjZUmvmvyHU:beeper.com' \\\n  --reminder '{remindAtMs: 0}'"
      },
      "php": {
        "method": "chats->reminders->create",
  ...
  },
  {
    ...
    "response": "{ chatID: string; messageID: string; reactionKey: string; success: true; transactionID: string; }",
    ...
    "perLanguage": {
      ...
      "cli": {
        ...
        "example": "beeper-desktop-cli chats:messages:reactions add \\\n  --access-token 'My Access Token' \\\n  --chat-id '!NCdzlIaMjZUmvmvyHU:beeper.com' \\\n  --message-id messageID \\\n  --reaction-key x"
      },
      "php": {
        "method": "chats->messages->reactions->add",
      ...
      "http": {
        "example": "curl http://localhost:23373/v1/chats/$CHAT_ID/messages/$MESSAGE_ID/reactions \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $BEEPER_ACCESS_TOKEN\" \\\n    -d '{\n          \"reactionKey\": \"x\"\n        }'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        ...
        "example": "beeper-desktop-cli chats:messages:reactions delete \\\n  --access-token 'My Access Token' \\\n  --chat-id '!NCdzlIaMjZUmvmvyHU:beeper.com' \\\n  --message-id messageID \\\n  --reaction-key x"
      },
      "php": {
        "method": "chats->messages->reactions->delete",
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "messages update",
        "example": "beeper-desktop-cli messages update \\\n  --access-token 'My Access Token' \\\n  --chat-id '!NCdzlIaMjZUmvmvyHU:beeper.com' \\\n  --message-id messageID \\\n  --text x"
      },
      "php": {
        "method": "messages->update",
      ...
      "http": {
        "example": "curl http://localhost:23373/v1/chats/$CHAT_ID/messages/$MESSAGE_ID \\\n    -X PUT \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $BEEPER_ACCESS_TOKEN\" \\\n    -d '{\n          \"text\": \"x\"\n        }'"
      }
    }
  },
  {
    ...
    "description": "Download a Matrix asset using its mxc:// or localmxc:// URL to the device running Beeper Desktop and return the local file URL.",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl http://localhost:23373/v1/assets/download \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $BEEPER_ACCESS_TOKEN\" \\\n    -d '{\n          \"url\": \"mxc://example.org/Q4x9CqGz1pB3Oa6XgJ\"\n        }'"
      }
    }
  },
  {
    ...
    "description": "Upload a file to a temporary location using multipart/form-data. Returns an uploadID that can be referenced when sending messages with attachments.",
    ...
    "response": "{ duration?: number; error?: string; fileName?: string; fileSize?: number; height?: number; mimeType?: string; srcURL?: string; uploadID?: string; width?: number; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl http://localhost:23373/v1/assets/upload \\\n    -H 'Content-Type: multipart/form-data' \\\n    -H \"Authorization: Bearer $BEEPER_ACCESS_TOKEN\" \\\n    -F 'file=@/path/to/file'"
      }
    }
  },
  {
    ...
    "description": "Upload a file using a JSON body with base64-encoded content. Returns an uploadID that can be referenced when sending messages with attachments. Alternative to the multipart upload endpoint.",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl http://localhost:23373/v1/assets/upload/base64 \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $BEEPER_ACCESS_TOKEN\" \\\n    -d '{\n          \"content\": \"x\"\n        }'"
      }
    }
  },
  {
    ...
    "description": "Stream a file given an mxc://, localmxc://, or file:// URL. Downloads first if not cached. Supports Range requests for seeking in large files.",
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "python": {
        ...
        "example": "from beeper_desktop_api import BeeperDesktop\n\nclient = BeeperDesktop()\ninfo = client.info.retrieve()\nprint(info.app)"
      },
      "go": {
      ...
      "http": {
        "example": "curl http://localhost:23373/v1/info \\\n    -H \"Authorization: Bearer $BEEPER_ACCESS_TOKEN\""
      }
    }
  }
];
